...
class AboutDishFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       val h2 = view.findViewById<TextView>(R.id.h2_f2)
        ...
        val ingredients = view.findViewById<TextView>(R.id.ingredients_f2)
        val text_ingredients = args.dishItem.ingredients
        ingredients.text=text_ingredients
